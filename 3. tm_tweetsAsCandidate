# code and guide from eight2late's "gentle introduction to text mining": https://eight2late.wordpress.com/2015/05/27/a-gentle-introduction-to-text-mining-using-r/
# important that corpus is in csv format, not xls!
library(tm)
docs <- Corpus(DirSource("/Users/ama1/Desktop/TrumpScraper/csv_final_raw/tweetsAsCandidate_new"))
...
write.csv(freqr, file="freqr_tweetsAsCandidate_new.csv")

# wordcloud -- part of this script because it runs off earlier code
library(wordcloud)
